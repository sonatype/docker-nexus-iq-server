...
ARG IQ_SERVER_SHA256=83d1135dce48578f7a187a0198b0fbcb9f06807757bd182f03a8cedaa032b7ea
ARG TEMP="/tmp/work"
...
&& microdnf install -y procps gzip unzip tar shadow-utils findutils util-linux less rsync git ruby \
&& microdnf clean all
