...
# Build parameters
ARG IQ_SERVER_VERSION=1.152.0-01
ARG IQ_SERVER_SHA256=7675b263c0f4fb1257a005aeb7a276866437065bd591b245b0eedbd0e3545df3
ARG TEMP="/tmp/work"
...
&& microdnf --setopt=install_weak_deps=0 --setopt=tsflags=nodocs install -y java-11-openjdk-devel \
