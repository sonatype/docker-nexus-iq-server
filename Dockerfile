...
FROM registry.access.redhat.com/ubi9/ubi-minimal:9.0.0-1608

# Build parameters
ARG IQ_SERVER_VERSION=1.144.0-05
ARG IQ_SERVER_SHA256=3ec3b22baa66e8649eb0b0bcfd5b6627e1b77182ae70314d97e5f5ca71b8be8f
ARG TEMP="/tmp/work"
