...
ARG IQ_SERVER_SHA256=17bc9e4539ba0c5ea8f6f03b1e850c6e8d4cf250e9521833e1384b4135df75a8
ARG TEMP="/tmp/work"
...
&& chmod -R u=rwx,g=rx,o=rx ${IQ_HOME} ${SONATYPE_WORK} ${CONFIG_HOME} ${LOGS_HOME}
