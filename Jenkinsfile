...
dockerizedBuildPipeline(
  ...
  buildAndTest: {
    validateExpectations([
        ...
        new Expectation('home-directory', 'ls', '-la /opt/sonatype/nexus-iq-server/ | awk \'\$9 !~ /^\\.*$/{print \$1,\$3,\$4,\$9}\'', 'drwxr-xr-x nexus nexus nexus-iq-server'),
        ...
        new Expectation('work-directory', 'ls', '-la /etc | grep nexus-iq-server | awk \'\$9 !~ /^\\.*$/{print \$1,\$3,\$4,\$9}\'', 'drwxr-xr-x nexus nexus nexus-iq-server'), 
        new Expectation('data-directory', 'test', '-f /etc/nexus-iq-server | echo $?', '0'), 
    ])
  },
