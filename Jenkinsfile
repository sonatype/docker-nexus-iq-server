      ...
      stage('Sign image') {
        ...
        withEnv(["DOCKER_CONFIG=${env.WORKSPACE_TMP}/.dockerConfig", 'DOCKER_CONTENT_TRUST=0']) {
          withCredentials([
            ...
            OsTools.runSafe(this, 'docker tag alpine:3.6 sonatype/sign-me:$(date +"%d%H%M%S")')
            ...
            OsTools.runSafe(this, """
             ...
             OsTools.runSafe(this, 'docker trust sign docker.io/sonatype/sign-me:$(date +"%d%H%M%S")')
          }
        }
      }
  } finally {
