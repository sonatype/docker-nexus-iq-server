...
// No arg → legacy in-container mode (UBI9/Alpine: runs cmds inside the image).
// With containerName → host inspects the running container via docker CLI
// (hardened: no shell utils required inside the runtime image).
