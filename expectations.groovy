...
def containerExpectations() {
  return [
    ...
    new Expectation('application-port', 'wget', '-q --spider --timeout=120 http://localhost:8070/ | echo $?', '0'),
    new Expectation('admin-port', 'wget', '-q --spider --timeout=120 http://localhost:8071/ | echo $?', '0'),
